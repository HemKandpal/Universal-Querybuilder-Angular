...
export interface RuleProperties extends BasicItemProperties {
  ...
  valueType?: any[],
  valueError?: any[],
  operatorOptions?: ImmMap<any, any>,
}
...
interface ConfigUtils {
  ...
  getFieldWidgetConfig(config: Config, field: FieldValue, operator: string, widget?: string, valueStr?: ValueSource): Widget | any;
  isJSX(jsx: any): boolean;
  isDirtyJSX(jsx: any): boolean;
  cleanJSX(jsx: any): Object;
  applyJsonLogic(logic: any, data?: any): any;
  getFieldParts(field: any, config?: any): any;
  getFieldPathParts(field: any, config: any, onlyKeys?: any): any;
}
...
export interface Utils extends Import, Export {
  RuleUtils: { getFieldPathLabels: any; };
  // case mode
...
export type JsonPathWidget<C = Config, WP = TextWidgetProps<C>> = BaseWidget<C, WP> & TextFieldSettings;
