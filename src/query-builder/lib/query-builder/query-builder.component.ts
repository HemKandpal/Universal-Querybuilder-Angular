...
export class QueryBuilderComponent implements OnInit, OnChanges, ControlValueAccessor, Validator {
  ...
  private defaultTemplateTypes: string[] = [
    'string', 'number', 'time', 'date', 'category', 'boolean', 'multiselect', 'json_path'];
  private defaultPersistValueTypes: string[] = [
    'string', 'number', 'time', 'date', 'boolean', 'json_path'];
  ...
  _changeField(fieldValue: any, rule: Rule): void {
    ...
    const nextField: Field = this.config.fields[fieldValue.value];
